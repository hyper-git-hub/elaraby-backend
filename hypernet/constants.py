...
TEXT_DOES_NOT_EXISTS = "Does Not Exist"

ONE_SIGNAL_APP_ID = '3d9e70b0-11ac-4375-9dee-6fa5036d2591' # for production key
ONE_SIGNAL_REST_API_KEY = 'ZjEwNDM3NmItMjcxOS00ZDlkLWJjNmQtNDFhMzdjMWI2OGY3'
...
SIGN_UP_FAILURE = "Cannot signup, Please contact system admin"
...
ASSET_IN_ACTIVITY = "Asset cannot be edited when a related activity is running."
...
secondary_email_list = ['waleed.shabbir@hypernymbiz.com', 'hamza.rizwan@hypernymbiz.com']
...
NOTIFICATION_DRIVER_ACKNOWLEDGE_BINS_UPDATE = 'notification_driver_acknowledge_bins_update'
NOTIFICATION_DRIVER_ACKNOWLEDGE_ACTIVITY_ABORT = 'notification_driver_acknowledge_activity_abort'
NOTIFICATION_ADMIN_ACTIVITY_REVIEW_BIN_CONFLICT = 'notification_admin_activity_review_bin_conflict'

ADD_EXISTING_RFID = 'You are trying to add an existing RFID. Please choose different RFID card/tag.'
SCANNER_DOES_NOT_EXIST = 'RFID Scanner does not exist. Please contact your administrator'
SCANNER_NOT_WITH_TRUCK = 'RFID Scanner is not associated with a Truck. Please contact your administrator'
RFID_TAG_CARD_DOES_NOT_EXIST = 'RFID Tag/Card does not exist. Please contact your administrator'
RFID_NOT_WITH_ASSET = 'RFID is not associated with any asset. Please contact your administrator'
RFID_ALREADY_WITH_ASSET = 'Scanned RFID/Tag is already assigned to an existing asset. Please choose different RFID Card/Tag'
...
ENTITY_PART_OF_ACTIVITY = ' Bin is already part of an activity to be collected. Please remove bin from list.'
...
logistics_options_dict = [
    ...
    {'id': 165, 'value': "Trip", 'key': 'jobstatus'},
    {'id': 166, 'value': "Trip Cancelled", 'key': 'jobstatus'},
    ...
    {'id': 159, 'key': IOF_MAINTENANCE_STATUSES, 'value': MAINTENANCE_WAITING_FOR_PARTS},
    {'id': 168, 'key': IOF_MAINTENANCE_STATUSES, 'value': MAINTENANCE_APPROVAL},
    {'id': 169, 'key': IOF_MAINTENANCE_STATUSES, 'value': MAINTENANCE_OPEN_INPROGRESS},
    {'id': 170, 'key': IOF_MAINTENANCE_STATUSES, 'value': MAINTENANCE_ACCEPTED},

    {'id': 167, 'key': IOF_MAINTENANCE_ACTIONS, 'value': ADDITION_OF_COST},
    ...
    {'id': 171, 'key': 'rfidapp', 'value': 'Report Maintenance'},
    {'id': 176, 'key': 'rfidapp', 'value': 'Contract Termination'},
    {'id': 177, 'key': 'rfidapp', 'value': 'Maintenance Pick up'},
    {'id': 178, 'key': 'rfidapp', 'value': 'Details Updated'},
    {'id': 179, 'key': 'rfidapp', 'value': 'Workshop Drop'},
    {'id': 180, 'key': 'rfidapp', 'value': 'Spare Bin Deposit'},
    {'id': 183, 'key': 'rfidapp', 'value': 'Package Dropped'},
    ...
    {'id': 146, 'key': 'trucktypes', 'value': "Tipper Truck"},
    {'id': 181, 'key': 'trucktypes', 'value': "Pickup Truck"},
    ...
    {'id': 140, 'key': NOTIFICATION_TYPE, 'value': NOTIFICATION_DRIVER_ACKNOWLEDGE_BINS_UPDATE},
    {'id': 141, 'key': NOTIFICATION_TYPE, 'value': NOTIFICATION_DRIVER_ACKNOWLEDGE_ACTIVITY_ABORT},
    {'id': 142, 'key': NOTIFICATION_TYPE, 'value': NOTIFICATION_ADMIN_ACTIVITY_REVIEW_BIN_CONFLICT},
    ...
    {'id': 143, 'key': 'jobstatus', 'value': 'Activity Updated'},
    {'id': 144, 'key': VESSEL_TYPES, 'value': CONTAINER},
    {'id': 145, 'key': VESSEL_TYPES, 'value': TANK},

    {'id': 158, 'key': SKIP_SIZES, 'value': '1.1 cbm'},
    {'id': 147, 'key': SKIP_SIZES, 'value': '2.5 cbm'},
    {'id': 148, 'key': SKIP_SIZES, 'value': '5 cbm'},
    {'id': 149, 'key': SKIP_SIZES, 'value': '8 cbm'},
    {'id': 150, 'key': SKIP_SIZES, 'value': '10 cbm'},
    {'id': 151, 'key': SKIP_SIZES, 'value': '12 cbm'},
    {'id': 152, 'key': SKIP_SIZES, 'value': '14 cbm'},
    {'id': 153, 'key': SKIP_SIZES, 'value': '18 cbm'},
    {'id': 154, 'key': SKIP_SIZES, 'value': '20 cbm'},
    {'id': 155, 'key': SKIP_SIZES, 'value': '26 cbm'},
    {'id': 156, 'key': SKIP_SIZES, 'value': '30 cbm'},
    {'id': 157, 'key': SKIP_SIZES, 'value': '240 liters'},
    {'id': 175, 'key': SKIP_SIZES, 'value': '40 cbm'},
    {'id': 182, 'key': SKIP_SIZES, 'value': 'Medical Waste'},

    {'id': 160, 'key': IOF_MAINTENANCE_DATA_STATUSES, 'value': MAINTENANCE_DATA_COST_LABOR},
    {'id': 161, 'key': IOF_MAINTENANCE_DATA_STATUSES, 'value': MAINTENANCE_DATA_COST_PARTS},
    {'id': 162, 'key': IOF_MAINTENANCE_DATA_STATUSES, 'value': MAINTENANCE_DATA_COST_TAXES},
    {'id': 163, 'key': IOF_MAINTENANCE_DATA_STATUSES, 'value': MAINTENANCE_DATA_COST_DISCOUNT},
    {'id': 164, 'key': IOF_MAINTENANCE_DATA_STATUSES, 'value': MAINTENANCE_DATA_COST_FINE},

    {'id': 172, 'key': TRIP_COST, 'value': FUEL_COST},
    {'id': 173, 'key': TRIP_COST, 'value': LABOUR_COST},
    {'id': 174, 'key': TRIP_COST, 'value': OTHER_COST},

    {'id': 184, 'key': WHEEL_TYPE, 'value': "6 wheeler"},
    {'id': 185, 'key': WHEEL_TYPE, 'value': "14 wheeler"},
    {'id': 186, 'key': WHEEL_TYPE, 'value': "18 wheeler"},
    {'id': 187, 'key': WHEEL_TYPE, 'value': "22 wheeler"},
...
FFP_VIOLATION_TYPES = "ffp_violations_type"
OUT_OF_ZONE = "out of zone"
IN_ZONE = "in zone"
OUT_OF_SITE = "out of site"
IN_SITE = "in site"

FFP_ATTENDANCE_TYPES = "ffp_attendance_types"
CHECK_IN = "checked in"
CHECK_OUT = "check out"

ffp_options_dict = [
    {'id': 1500, 'key': EMPLOYEE_TYPE, 'value': SITE_SUPERVISOR},
    {'id': 1501, 'key': EMPLOYEE_TYPE, 'value': ZONE_SUPERVISOR},
    {'id': 1502, 'key': EMPLOYEE_TYPE, 'value': TEAM_SUPERVISOR},
    {'id': 1503, 'key': EMPLOYEE_TYPE, 'value': LABOUR},
    {'id': 1504, 'key': TASK_STATUSES, 'value': TASK_COMPLETED},
    {'id': 1505, 'key': TASK_STATUSES, 'value': TASK_APPROVED},
    {'id': 1506, 'key': FFP_VIOLATION_TYPES, 'value': OUT_OF_ZONE},
    {'id': 1507, 'key': FFP_ATTENDANCE_TYPES, 'value': CHECK_IN},
    {'id': 1508, 'key': FFP_ATTENDANCE_TYPES, 'value': CHECK_OUT},
    {'id': 1509, 'key': FFP_VIOLATION_TYPES, 'value': IN_ZONE},
    {'id': 1510, 'key': FFP_VIOLATION_TYPES, 'value': IN_SITE},
    {'id': 1511, 'key': FFP_VIOLATION_TYPES, 'value': OUT_OF_SITE},
]

IOP_DEVICE_TYPES = "iop_devices_types"
AIR_CONDITIONER = "Air Conditioner"
WATER_HEATER = "Water Heater"
REFRIGIRATOR = "Refrigirator"
DEEP_FREEZER = "Deep Freezer"
WASHING_MACHINE = "Washing Machine"
WATER_DISPENSER = "Water Dispernser"

WATER_HEATER_MODELS = "water_heater_models"
...
APPLIANCE_TEMPERATURE = "Appliance Temperature"
IOP_USE_NOW = "Iop Use Now"

IOP_SCHEDULE_STATUS = "Iop Schedule Status"

IOP_SCHEDULE_READY = "Ready"
IOP_SCHEDULE_IN_USE = "In Use"
IOP_SCHEDULE_COMPLETED = "Completed"
IOP_SCHEDULE_CANCELLED = "Cancelled"

RECURRING_SLEEP_MODE = "Recurring Sleep Mode"
iop_options_dict = [
    {'id': 2000, 'value': AIR_CONDITIONER, 'key': IOP_DEVICE_TYPES},
    {'id': 2001, 'value': WATER_HEATER, 'key': IOP_DEVICE_TYPES},
    {'id': 2002, 'value': REFRIGIRATOR, 'key': IOP_DEVICE_TYPES},
    {'id': 2003, 'value': DEEP_FREEZER, 'key': IOP_DEVICE_TYPES},
    {'id': 2004, 'value': WASHING_MACHINE, 'key': IOP_DEVICE_TYPES},
    {'id': 2005, 'value': WATER_DISPENSER, 'key': IOP_DEVICE_TYPES},

    {'id': 2006, 'value': WATER_HEATER_MODEL_1, 'key': WATER_HEATER_MODELS},
    {'id': 2007, 'value': WATER_HEATER_MODEL_2, 'key': WATER_HEATER_MODELS},
    {'id': 2008, 'value': WATER_HEATER_MODEL_3, 'key': WATER_HEATER_MODELS},
    {'id': 2009, 'value': WATER_HEATER_MODEL_4, 'key': WATER_HEATER_MODELS},
    {'id': 2010, 'value': IOP_SCHEDULE_ON_DEMAND, 'key': IOP_SCHEDULE},
    {'id': 2011, 'value': IOP_SCHEDULE_DAILY, 'key': IOP_SCHEDULE},
    {'id': 2012, 'value': IOP_QUICK_SCHEDULE, 'key': IOP_SCHEDULE},
    {'id': 2016, 'value': IOP_SLEEP_MODE, 'key': IOP_SCHEDULE},

    {'id': 2013, 'value': IOP_QUICK_SCHEDULE, 'key': APPLIANCE_TEMPERATURE},
    {'id': 2014, 'value': IOP_QUICK_SCHEDULE, 'key': APPLIANCE_TEMPERATURE},
    {'id': 2015, 'value': IOP_QUICK_SCHEDULE, 'key': APPLIANCE_TEMPERATURE},
    {'id': 2017, 'value': IOP_USE_NOW, 'key': IOP_SCHEDULE},

    {'id': 2018, 'value': IOP_SCHEDULE_READY, 'key': IOP_SCHEDULE_STATUS},
    {'id': 2019, 'value': IOP_SCHEDULE_IN_USE, 'key': IOP_SCHEDULE_STATUS},
    {'id': 2020, 'value': IOP_SCHEDULE_COMPLETED, 'key': IOP_SCHEDULE_STATUS},
    {'id': 2021, 'value': IOP_SCHEDULE_CANCELLED, 'key': IOP_SCHEDULE_STATUS},
    {'id': 2022, 'value': RECURRING_SLEEP_MODE, 'key': IOP_SCHEDULE},
...
IOT_HUB_URL = 'https://{0}.azure-devices.net/devices/{1}/messages/events?api-version=2015-08-15-preview'

AVERAGE_HEART_RATE = 90
TOTAL_STEPS = 50
demo_trucks = [6, 7, 8, 10, 11, 12]

duplicate_bins = ["E20051741514017018905098",
                  "E2005142050E01520500DDDE",
                  "E2005174151301851250981D",
                  "E2005174151400250870C16B",
                  "E2005142050E017012409898",
                  "E200517415140170130095BA",
                  "E2005174150601281160A288",
                  "E200517415130204168068FF",
                  "E200001692160198183059DD",
                  "E20051741514018313209155",
                  "E200517415140164128095AF",
                  "E2005142050E0090255013F7",
                  "E2005142050E0090255013F7",
                  "E2005142050D02521030ABD3",
                  "E20000169216019018805799",
                  "E2000016921602671100AB16",
                  "E2000017941501201120A949",
                  "E2005174151301970700D434",
                  "E2000016921400930840C631",
                  "E2000017941501830480E4EB",
                  "E2000017941501842230300E",
                  "E2005174151401760470E6E4",
                  "E2000016921602331290975B",
                  "E20000166609023521903465",
                  "E2005142050E008024401B6C",
                  "E2000016921602340810C93A",
                  "E20051741506009116406C97",
                  "E200001692160238175062EE",
                  "E2005142050E01120480E17C",
                  "E2005174151302501310941A",
                  "E2000016921402771140A6EF",
                  "E2005174151400852030433B",
                  "E2005142050D02580900BB56",
                  "E200517415130266197048D7",
                  "E2000017941500381300930E",
                  "E20000169216015819404ECF",
                  "E2005142050D02581160A288",
                  "E2000016921401480240F3DB",
                  "E20000169216017422503069",
                  "E200517415140198214039D9",
                  "E2005142050D02811030AB5F",
                  "E20051741514004719204D8E",
                  "E2000016921402370880C36A",
                  "E20051741514017319704820",
                  "E2000016921400590970B80B",
                  "E2005142050E001412409628",
                  "E20000179414003617905C5D",
                  "E20051741513018313409151",
                  "E20051741513028418405806",
                  "E2005174151400410790C989",
                  "E2000016921401090740CDE6",
                  "E20051741514017717106682",
                  "E20051741514003012309B34",
                  "E2005174151401910600DB66",
                  "E2000016921602580860C398",
                  "E20051741513027312609AF9",
                  "E20051741513026216806970",
                  "E2005174151400620880BFB6",
                  "E2000016921400720740CD90",
                  "E2000017941700450820C4FD",
                  "E2005174151400801090A8BF",
                  "E20000179415020917805FE7",
                  "E2000017941502170900BE87",
                  "E2000017941701600950B826",
                  "E20000157307008422003512",
                  "E20000175918020718105E4A",
                  "E2005174151400390770C980",
                  "E2000016921402181050B10C",
                  "E2000017941801891930508C",
                  "E20051741514017720503FD5",
                  "E20000179415018220004A23",
                  "E2000017941500300970B721",
                  "E20051741513020924601C0C",
                  "E2000017941501810330EE04"
                  ]

email_list_iop = ['taimoor.mirza@metispvt.com', 'shamis.asghar@hypernymbiz.com']

# iop constants
tpd = {'45': 1.9, '55': 2.4, '65': 2.8}
#///adding line 747
degree_drop_per_minute_in_sec ={'45':116,'55':146,'65':170}
iop_devices = ['homeAppliances-testDevice1', 'homeAppliances-testDevice2', 'homeAppliances-testDevice3',
               'homeAppliances-testDevice4']
SLEEP_MODE_TEMP = 35
DEFAULT_TEMP = 55
ACTIVITY_TEMP = 75
water_ranges = {'Warm Water': range(35, 51),
                'Hot Water': range(51, 66),
                'Very Hot Water': range(66, 76)}
warm_water = 50
hot_water = 60
very_hot_water = 70
temp_mixed_water = {warm_water: 37, hot_water: 40, very_hot_water: 43}
ft = 5
q = 5
Q = 5
UF=0.6
open_weaher_api_key = "141523b1b662398b2fa8dc908a23e14e"
current_city = 'cairo'
open_weather_api_url = 'http://api.openweathermap.org/data/2.5/weather?appid={}&q={}&units=metric'.format(
    open_weaher_api_key, current_city)

quick_schedule_fixed_duration = '60'

temperatures = [warm_water, hot_water, very_hot_water]

rand_durations = {'45': {warm_water: 5, hot_water: 6, very_hot_water: 7},
                  '55': {warm_water: 7, hot_water: 8, very_hot_water: 9},
                  '65': {warm_water: 10, hot_water: 10, very_hot_water: 10}}
# rand_durations = {'45': {warm_water: 18, hot_water: 15, very_hot_water: 12},
#                   '55': {warm_water: 20, hot_water: 17, very_hot_water: 15},
#                   '65': {warm_water: 30, hot_water: 22, very_hot_water: 17}}


DEFAULT_EVENT_DESIRED_TEMPERATURE = 75